...
#include "ui_ResizeModelDialog.h"

class ResizeModelDialog : 
    public QDialog, public Ui::ResizeModelDialog
{
    Q_OBJECT
public:
    ResizeModelDialog(QWidget* parent=0);
private slots:
    void scalemax_toggled(bool checked);
    void scalexyz_toggled(bool checked);
};
